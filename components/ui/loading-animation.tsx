...
export function LoadingAnimation({ className, size = 80 }: LoadingAnimationProps) {
    return (
        <div className={cn("flex items-center justify-center", className)}>
            ...
            >
                ...
                <motion.div
                    ...
                    style={{
                        background: "radial-gradient(circle, rgba(229, 164, 203, 0.3) 0%, transparent 70%)",
                        filter: "blur(20px)",
                    }}
                    animate={{
                        scale: [1, 1.2, 1],
                ...
                {/* <motion.div
                    ...
                    style={{
                        border: "2px solid rgba(229, 164, 203, 0.3)",
                        borderRadius: "50%",
                        borderTopColor: "#e5a4cb",
...
export default function LoadingDemo() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex flex-col items-center justify-center gap-12 p-8">

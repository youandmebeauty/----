...
export function LoadingAnimation({ className, size = 80 }: LoadingAnimationProps) {
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            gsap.fromTo(wrapper, { opacity: 0, scale: 0.8 }, { opacity: 1, scale: 1, duration: 0.3, ease: "power1.out" })
            const paths = svg.querySelectorAll("path")
            gsap.fromTo(paths, { opacity: 0 }, { opacity: 1, duration: 1.5, ease: "power1.out", stagger: 0.15 })
        }, wrapper)
    ...
    return (
        <div className={cn("flex items-center justify-center", className)}>
            ...
            >
                {/* Animated SVG Logo */}
                <svg ref={svgRef} viewBox="0 0 1080 1080" className="h-full w-full">
                    <defs>
                        <linearGradient id="logoGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                            <stop offset="0%" stopColor="#e5a4cb">
                                <animate attributeName="stop-color" values="#e5a4cb;#f0b8d9;#e5a4cb" dur="2s" repeatCount="indefinite" />
                            </stop>
                            <stop offset="100%" stopColor="#d890bb">
                                <animate attributeName="stop-color" values="#d890bb;#e5a4cb;#d890bb" dur="2s" repeatCount="indefinite" />
                            </stop>
                        </linearGradient>

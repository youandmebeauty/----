...
export function WhyChooseUs() {
    return (
        <>
        <div className=" hidden md:block py-20 relative overflow-hidden">
            {/* Background Elements */}
                ...
                >
                    {values.map((value) => {
                        ...
                        return (
                            <div
                                key={value.title}
                                className="group block relative bg-card/50 backdrop-blur-sm border border-border/50 rounded-3xl p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-700 hover:-translate-y-3 overflow-hidden"
                            >
